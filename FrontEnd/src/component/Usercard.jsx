...
const Usercard = ({ user }) => {
    ...
    const handlesendreq = async (status, userid) => {
        try {
            ...
            // Remove the user from the feed after successful request
    ...
    return (
        <div className="flex justify-center p-4">
            <div className="card w-full max-w-sm bg-gradient-to-br from-gray-700 to-gray-800 text-white rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden">
                {/* Profile Image */}
                <figure className="h-70 overflow-hidden relative">
                    <img
                        src={profile}
                ...
                <div className="grid grid-cols-2 gap-3 p-3">
                    <div className="bg-blue-500 backdrop-blur-sm p-3 rounded-lg text-center">
                        <button 
                            className="text-sm font-semibold text-white cursor-pointer w-full"
